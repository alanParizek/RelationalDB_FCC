...
--
-- Name: elements c1; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT c1 UNIQUE (symbol);


--
-- Name: elements c2; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
